...
title: Uses
date: 1655980885868
updated: 1655984424775
---
This is my `/uses` page, showing my current up-to-date setup.
## Editor
- **Visual Studio Code**, for mostly everything.
- **Vim**, if I need a lightweight editor.
### Editor themes
- **Electron Higlighter**.
### Editor extensions
...
- The motherboard is a **MSI MPG x570 GAMING PRO CARBON WIFI ATX**.
- 1TB of space currently supplied by a **Samsung 970 EVO M.2-2280 NVME**.
- 16GB of memory thanks to **Corsair Vengeance LPX 16 GB (2 x 8 GB) DDR4-3200 CL16**.
- **Antec NX600 ATX Mid Tower Case**.
### Screens
- Two **Skyworth F27G1Q**, one in portrait and the other in landscape modes. I got them from a gig, they're 27'', 1440p up to 165Hz, 10-bit color support and HDR 400.
### Peripherics
- **Tonor TC30** mic with pop filter. Thanks to @nomedalavidadev and @infojobs :)
- **Razer Ornata Chroma**, membrane keyboard with wrist rest.
- **Steelseries Rival 5 Destiny**. Destiny has been one of the games I've played the most, so I got this special edition mouse.
- **The Great Wave off Kanagawa Mousepad**. I love Hokusai art.
